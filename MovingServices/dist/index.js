...
var MemStorage = class {
  ...
  async createContactSubmission(submission) {
    ...
    console.log(`New contact submission: ${JSON.stringify(contactSubmission)}`);
...
var contactSubmissionSchema = createInsertSchema(contactSubmissions).pick({
  name: true,
  phone: true,
  email: true,
  serviceType: true,
...
async function registerRoutes(app2) {
  app2.post("/api/contact", async (req, res) => {
    try {
      ...
      res.status(201).json({
        message: "Dzi\u0119kujemy za wiadomo\u015B\u0107! Skontaktujemy si\u0119 wkr\xF3tce.",
        id: submission.id
      });
    } catch (error) {
